...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="index.html" class="logo d-flex align-items-center">
                ...
                <span class="d-none d-lg-block">    NiceTry</span>
            </a>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request()->routeIs('test') ? ''  : 'collapsed'}}" href="{{ route('test') }}">
                    <i class="bi bi-layout-text-window-reverse"></i><span>Data Test</span>
                </a>
            </li><!-- End Tables Nav -->

            <li class="nav-item">
                <a class="nav-link {{ Request()->routeIs('videos') ? '' : 'collapsed'}}" href="{{ route('videos') }}">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#">
                    <i class="bi bi-book"></i><span>Articles</span>
                </a>
            </li><!-- End Video Nav -->
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span>NiceTry</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
